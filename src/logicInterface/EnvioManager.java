...
/**
 * Interface que define las operaciones para gestionar envíos. Proporciona
 * métodos para añadir, actualizar, eliminar y filtrar envíos en el sistema.
 * Cada método puede lanzar una excepción específica si ocurre un error durante
 * su ejecución.
 *
 * Los métodos permiten trabajar con los envíos en formato JSON y XML,
 * permitiendo realizar operaciones CRUD (crear, leer, actualizar, eliminar) y
 * filtrados por diferentes criterios.
 *
 * @author Alder
 */
public interface EnvioManager {
    ...
    /**
     * Obtiene una lista de todos los envíos registrados en el sistema en
     * formato JSON.
     *
    ...
    /**
     * Filtra los envíos registrados en el sistema por un rango de fechas en
     * formato JSON.
     *
     * @param responseType el tipo de clase para mapear la respuesta JSON.
     * @param firstDate la fecha inicial del rango.
     * @param secondDate la fecha final del rango.
     * @return una lista de objetos {@link Envio} que cumplen con el rango de
     * fechas especificado.
     ...
     *
     * @param responseType el tipo de clase para mapear la respuesta JSON.
     * @param estado el estado a filtrar (por ejemplo, "PREPARACION",
     * "EN_REPARTO", "ENTREGADO").
     * @return una lista de objetos {@link Envio} que tienen el estado
     * especificado.
     * @throws WebApplicationException si ocurre un error al filtrar los datos.
     */
    ...
    /**
     * Filtra los envíos registrados en el sistema por el número de paquetes en
     * formato JSON.
     *
     * @param responseType el tipo de clase para mapear la respuesta JSON.
     * @param numPaquetes el número de paquetes a filtrar.
     * @return una lista de objetos {@link Envio} que cumplen con el número de
     * paquetes especificado.
     * @throws WebApplicationException si ocurre un error al filtrar los datos.
     */
