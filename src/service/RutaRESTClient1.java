 ...
 * @author Borja
 */
public class RutaRESTClient1 implements AutoCloseable {

    private final Client client;
    private final WebTarget webTarget;
    private static final String BASE_URI = "http://localhost:8080/FleetIQ_Server/webresources";
    private static final Logger LOGGER = Logger.getLogger(RutaRESTClient1.class.getName());

    public RutaRESTClient1() {
        try {
